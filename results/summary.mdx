...
<Frame>
  [VIDEO: Loom walkthrough of the Summary tab — metrics, decision cards, findings, debates. ~2 minutes.]
</Frame>
...
<Frame>
  [IMAGE: The Summary view showing metrics row and a decision card with verdict, confidence, and evidence]
</Frame>
